  ...
  return (
    <div className="md:mt-8 mt-4">
      ...
      <div className="flex md:flex-row items-center justify-between mb-8">
        ...
        <div className="flex md:flex-row gap-2 flex-col">
          <Button
            ...
            className={cn(
              'bg-transparent',
              selectedFilter === 'today' ? 'text-chart-3 border-chart-3' : 'text-ring border-ring',
            )}
          >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-4 md:mb-8">
        {/* New Leads */}
        <Card className="border-ring/30 bg-transparent">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
        ...
        {/* Events Section */}
        <Card className="border-ring/30 bg-transparent min-h-[210px]">
          <CardHeader className="flex flex-row items-center justify-between">
                    ...
                    >
                      ...
                      {startTime && (
                        <span className={cn('font-medium', mainColor)}>
                          {format(startTime, 'MM.dd. HH:mm', { locale: dateLocale })}
                        </span>
                      )}
                    </div>
                  )
